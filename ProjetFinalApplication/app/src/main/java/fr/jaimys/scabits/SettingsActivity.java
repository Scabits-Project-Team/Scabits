...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdapterView.OnItemSelectedListener onItemSelectedListenerParent = new AdapterView.OnItemSelectedListener() {
            @Override
        ...
        AdapterView.OnItemSelectedListener onItemSelectedListenerChild = new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String timeString = parent.getItemAtPosition(position).toString();
                int time = Integer.parseInt(timeString.substring(0, timeString.length() - 1));
        ...
        ArrayAdapter<CharSequence> arrayAdapterParent = ArrayAdapter.createFromResource(this, R.array.timeParent, android.R.layout.simple_spinner_item);
        ...
        ArrayAdapter<CharSequence> arrayAdapterChild = ArrayAdapter.createFromResource(this, R.array.timeChild, android.R.layout.simple_spinner_item);
